...
namespace SupervisorioDana
{
	...
	public partial class visual1920x1080 : Form
	{
		// Token: 0x060000CA RID: 202 RVA: 0x00011274 File Offset: 0x0000F474
		public visual1920x1080()
		{
			this.InitializeComponent();
		}

		// Token: 0x060000CB RID: 203 RVA: 0x000112C3 File Offset: 0x0000F4C3
		private void grafico_Load(object sender, EventArgs e)
		{
		}

		// Token: 0x060000CC RID: 204 RVA: 0x000112C8 File Offset: 0x0000F4C8
		...
		// Token: 0x060000CD RID: 205 RVA: 0x00011328 File Offset: 0x0000F528
		...
		// Token: 0x060000CE RID: 206 RVA: 0x00011434 File Offset: 0x0000F634
		public void conexao()
		{
		...
		// Token: 0x060000CF RID: 207 RVA: 0x000114A0 File Offset: 0x0000F6A0
		...
		// Token: 0x060000D0 RID: 208 RVA: 0x00011590 File Offset: 0x0000F790
		...
		// Token: 0x060000D1 RID: 209 RVA: 0x000115B2 File Offset: 0x0000F7B2
		private void pictureBox1_Click(object sender, EventArgs e)
		{
			Environment.Exit(0);
		}

		// Token: 0x060000D2 RID: 210 RVA: 0x000115BC File Offset: 0x0000F7BC
		...
		// Token: 0x060000D3 RID: 211 RVA: 0x00012738 File Offset: 0x00010938
		...
		// Token: 0x060000D4 RID: 212 RVA: 0x00012A0A File Offset: 0x00010C0A
		...
		// Token: 0x060000D5 RID: 213 RVA: 0x00012A2C File Offset: 0x00010C2C
		...
		// Token: 0x060000D6 RID: 214 RVA: 0x000145BC File Offset: 0x000127BC
		private void abrirvisualcarro()
		{
			...
			this.Car9.SetBounds(1745, 115, 0, 0);
			this.Car10.SetBounds(1655, 115, 0, 0);
			this.Car11.SetBounds(1565, 115, 0, 0);
			this.Car12.SetBounds(1475, 115, 0, 0);
			this.Car13.SetBounds(1385, 115, 0, 0);
			this.Car14.SetBounds(1295, 115, 0, 0);
			this.Car15.SetBounds(1205, 115, 0, 0);
			this.Car16.SetBounds(1115, 115, 0, 0);
			this.Car17.SetBounds(1025, 115, 0, 0);
			this.Car18.SetBounds(935, 115, 0, 0);
			this.Car19.SetBounds(845, 115, 0, 0);
			this.Car20.SetBounds(755, 115, 0, 0);
			this.Car21.SetBounds(665, 115, 0, 0);
			this.Car22.SetBounds(575, 115, 0, 0);
			this.Car23.SetBounds(485, 115, 0, 0);
			this.Car24.SetBounds(395, 115, 0, 0);
			this.Car25.SetBounds(285, 115, 0, 0);
			this.Car8.SetBounds(1745, 940, 0, 0);
			this.Car7.SetBounds(1655, 940, 0, 0);
			this.Car6.SetBounds(1565, 940, 0, 0);
			this.Car5.SetBounds(1475, 940, 0, 0);
			this.Car4.SetBounds(1385, 940, 0, 0);
			this.Car3.SetBounds(1295, 940, 0, 0);
			this.Car2.SetBounds(1205, 940, 0, 0);
			this.Car1.SetBounds(1115, 940, 0, 0);
			this.Car33.SetBounds(1025, 940, 0, 0);
			this.Car32.SetBounds(935, 940, 0, 0);
			this.Car31.SetBounds(845, 940, 0, 0);
			this.Car30.SetBounds(755, 940, 0, 0);
			this.Car29.SetBounds(665, 940, 0, 0);
			this.Car28.SetBounds(575, 940, 0, 0);
			this.Car27.SetBounds(485, 940, 0, 0);
			this.Car26.SetBounds(395, 940, 0, 0);
		}

		// Token: 0x060000D7 RID: 215 RVA: 0x00014C0C File Offset: 0x00012E0C
		private void fecharvisualcarro()
		{
			...
			this.Car9.SetBounds(1745, 485, 0, 0);
			this.Car10.SetBounds(1655, 415, 0, 0);
			this.Car11.SetBounds(1565, 415, 0, 0);
			this.Car12.SetBounds(1475, 415, 0, 0);
			this.Car13.SetBounds(1385, 415, 0, 0);
			this.Car14.SetBounds(1295, 415, 0, 0);
			this.Car15.SetBounds(1205, 415, 0, 0);
			this.Car16.SetBounds(1115, 415, 0, 0);
			this.Car17.SetBounds(1025, 415, 0, 0);
			this.Car18.SetBounds(935, 415, 0, 0);
			this.Car19.SetBounds(845, 415, 0, 0);
			this.Car20.SetBounds(755, 415, 0, 0);
			this.Car21.SetBounds(665, 415, 0, 0);
			this.Car22.SetBounds(575, 415, 0, 0);
			this.Car23.SetBounds(485, 415, 0, 0);
			this.Car24.SetBounds(395, 415, 0, 0);
			this.Car25.SetBounds(285, 530, 0, 0);
			this.Car8.SetBounds(1745, 575, 0, 0);
			this.Car7.SetBounds(1655, 640, 0, 0);
			this.Car6.SetBounds(1565, 640, 0, 0);
			this.Car5.SetBounds(1475, 640, 0, 0);
			this.Car4.SetBounds(1385, 640, 0, 0);
			this.Car3.SetBounds(1295, 640, 0, 0);
			this.Car2.SetBounds(1205, 640, 0, 0);
			this.Car1.SetBounds(1115, 640, 0, 0);
			this.Car33.SetBounds(1025, 640, 0, 0);
			this.Car32.SetBounds(935, 640, 0, 0);
			this.Car31.SetBounds(845, 640, 0, 0);
			this.Car30.SetBounds(755, 640, 0, 0);
			this.Car29.SetBounds(665, 640, 0, 0);
			this.Car28.SetBounds(575, 640, 0, 0);
			this.Car27.SetBounds(485, 640, 0, 0);
			this.Car26.SetBounds(395, 640, 0, 0);
		}

		// Token: 0x060000D8 RID: 216 RVA: 0x0001528C File Offset: 0x0001348C
		private void fecharcarrosvisual_Click(object sender, EventArgs e)
		{
			...
			if (flag)
			{
				...
				this.travado = true;
				this.labNsetor2.SetBounds(400, 365, 0, 0);
				this.labNsetor3.SetBounds(660, 365, 0, 0);
				this.labNsetor4.SetBounds(920, 365, 0, 0);
				this.labNsetor5.SetBounds(1175, 365, 0, 0);
				this.labNsetor6.SetBounds(1330, 355, 0, 0);
				this.labNsetor7.SetBounds(1460, 355, 0, 0);
				this.labNsetor8.SetBounds(1600, 355, 0, 0);
				this.labNsetor9.SetBounds(1740, 365, 0, 0);
				this.labNsetor1.SetBounds(730, 740, 0, 0);
				this.labNsetor13.SetBounds(1320, 740, 0, 0);
				this.labNsetor12.SetBounds(1480, 740, 0, 0);
				this.labNsetor11.SetBounds(1555, 740, 0, 0);
				this.labNsetor10.SetBounds(1660, 740, 0, 0);
				this.CorSetor2.SetBounds(277, 408, 0, 0);
				this.CorSetor2n2.SetBounds(367, 408, 0, 0);
				this.CorSetor3.SetBounds(657, 408, 0, 0);
				this.CorSetor4.SetBounds(747, 408, 0, 0);
				this.CorSetor5.SetBounds(1167, 408, 0, 0);
				this.CorSetor6.SetBounds(1257, 408, 0, 0);
				this.CorSetor7.SetBounds(1467, 408, 0, 0);
				this.CorSetor8.SetBounds(1557, 408, 0, 0);
				this.CorSetor9.SetBounds(1737, 408, 0, 0);
				this.CorSetor2n1.Visible = true;
				this.CorSetor1.SetBounds(367, 633, 0, 0);
				this.CorSetor13.SetBounds(1287, 633, 0, 0);
				this.CorSetor12.SetBounds(1467, 633, 0, 0);
				this.CorSetor11.SetBounds(1557, 633, 0, 0);
				this.CorSetor10.SetBounds(1647, 633, 0, 0);
				this.CorSetor9n2.SetBounds(1737, 633, 0, 0);
			...
			else
			{
				...
				if (flag2)
				{
					...
					this.travado = false;
					this.labNsetor2.SetBounds(400, 65, 0, 0);
					this.labNsetor3.SetBounds(660, 65, 0, 0);
					this.labNsetor4.SetBounds(920, 65, 0, 0);
					this.labNsetor5.SetBounds(1175, 65, 0, 0);
					this.labNsetor6.SetBounds(1330, 55, 0, 0);
					this.labNsetor7.SetBounds(1460, 55, 0, 0);
					this.labNsetor8.SetBounds(1600, 55, 0, 0);
					this.labNsetor9.SetBounds(1740, 65, 0, 0);
					this.labNsetor1.SetBounds(730, 1040, 0, 0);
					this.labNsetor13.SetBounds(1320, 1040, 0, 0);
					this.labNsetor12.SetBounds(1480, 1040, 0, 0);
					this.labNsetor11.SetBounds(1555, 1040, 0, 0);
					this.labNsetor10.SetBounds(1660, 1040, 0, 0);
					this.CorSetor2.SetBounds(277, 108, 0, 0);
					this.CorSetor2n2.SetBounds(367, 108, 0, 0);
					this.CorSetor3.SetBounds(657, 108, 0, 0);
					this.CorSetor4.SetBounds(747, 108, 0, 0);
					this.CorSetor5.SetBounds(1167, 108, 0, 0);
					this.CorSetor6.SetBounds(1257, 108, 0, 0);
					this.CorSetor7.SetBounds(1467, 108, 0, 0);
					this.CorSetor8.SetBounds(1557, 108, 0, 0);
					this.CorSetor9.SetBounds(1737, 108, 0, 0);
					this.CorSetor2n1.Visible = false;
					this.CorSetor1.SetBounds(367, 933, 0, 0);
					this.CorSetor13.SetBounds(1287, 933, 0, 0);
					this.CorSetor12.SetBounds(1467, 933, 0, 0);
					this.CorSetor11.SetBounds(1557, 933, 0, 0);
					this.CorSetor10.SetBounds(1647, 933, 0, 0);
					this.CorSetor9n2.SetBounds(1737, 933, 0, 0);
		...
		// Token: 0x060000D9 RID: 217 RVA: 0x00015840 File Offset: 0x00013A40
		...
		// Token: 0x060000DA RID: 218 RVA: 0x00015880 File Offset: 0x00013A80
		private void pictureBox2_Click(object sender, EventArgs e)
		{
			base.WindowState = FormWindowState.Minimized;
		}

		// Token: 0x060000DB RID: 219 RVA: 0x0001588B File Offset: 0x00013A8B
		...
		public visual1920x1080.carros[] carro = new visual1920x1080.carros[33];

		// Token: 0x04000108 RID: 264
		public visual1920x1080.carros[] carroordenado = new visual1920x1080.carros[33];
